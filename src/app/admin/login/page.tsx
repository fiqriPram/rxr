    ...
    <div className="mx-auto flex min-h-[70vh] max-w-sm flex-col items-center justify-center px-4">
      <div className="w-full rounded-xl border border-line bg-panel p-6 shadow-sm">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-base font-bold text-white">Login Admin</h1>
        </div>
        <p className="mt-1 text-xs text-slate-400">
          Area terbatas. Masukkan password admin untuk melanjutkan.
        </p>
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-3">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-cyan-500 via-blue-600 to-indigo-600 px-4 py-2.5 text-sm font-bold text-white transition hover:scale-[1.01] disabled:opacity-50"
          >
